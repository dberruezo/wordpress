...
class Wpens_Scripts {
	...
	public function wpens_public_scripts() {
		...
		wp_localize_script( 'wpens-public-js', 'WpEns', array(
															...
															'fname_empty' => __( 'Introduce un nombre.', 'wpens' ),
															'lname_empty' => __( 'Introduce tu apellido.', 'wpens' ),
															'email_empty' => __( 'Introduce un email válido.', 'wpens' ),
															'nwscheck' => __( 'Debes aceptar la política de privacidad.', 'wpens' ),
															'email_valid' => __( 'Introduce un email válido.', 'wpens' )
														) );
