...
class Wpens_Admin {
	...
	public function wpens_ltable_add_menu_page() {
		...
		$wpens_setting = add_menu_page( __( 'Newsletter', 'wpens' ), __( 'Newsletter', 'wpens' ), 'manage_options','wpens-list', array($this, 'wpens_ltable_newsletter_list') , WPENS_PLUGIN_URL.'/images/icon.jpg' );
