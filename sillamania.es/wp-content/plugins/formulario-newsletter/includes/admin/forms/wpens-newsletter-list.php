...
class Wpens_Subscribers_List extends WP_List_Table {
	...
	public function get_columns(){
		...
		$columns = array(
						...
						'email'			=> __( 'Email', 'wpens' ),
                        'first_name'    => __( 'Nombre', 'wpens' ),
                        'last_name'     => __( 'Apellidos', 'wpens' ),
						'date'			=> __( 'Fecha', 'wpens' )
					);
        return $columns;
    }
	...
	public function no_items() {
		_e( 'No se han encontrado registros.', 'wpens' );
	}
	...
	public function process_bulk_action() {
        ...
        if( 'delete'===$this->current_action() ) {
        	wp_die(__( 'Suscritor Eliminado correctamente.', 'wpens' ));
        } 
...
<div class="wrap">	
	...
	<form id="newsletter-filter" method="get">
		...
		<h1 class="wp-heading-inline"><?php _e( 'Signup Users', 'wpens' ); ?></h1>
