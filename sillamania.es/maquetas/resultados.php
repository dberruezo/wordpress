...
<body class="distribuidora">
	...
	<div class="container-hero-resultados">
		<div class="bloque-left"></div>
		<div class="bloque-right">
			<h2>Disfruta de las novedades</h2>
			<p>20% <span>dto</span></p>
		</div>
	</div>

	<div class="container">	
		<div class="container-header-filtros">
			<h2><span>36</span> Resultados en chaselongue</h2>
			<div class="bloque-right">
				...
				<i class="fa icon-filters before-filtro"></i>
	...
	<script src="_/js/distribuidora.js"></script>
