...
function davidberruezo_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'davidberruezo' ),
		'social'  => __( 'Social Links Menu', 'davidberruezo' ),
	) );
...
add_action( 'after_setup_theme', 'davidberruezo_setup' );
 ...
 * @since Twenty Sixteen 1.0
 */
function davidberruezo_scripts() {
    ...
    wp_enqueue_script('easy-pie-chart', get_template_directory_uri() .'/js/jquery.easypiechart.min.js' );
...
add_action( 'wp_enqueue_scripts', 'davidberruezo_scripts' );
